...
const Login = () => {
  ...
  return (
    <>
      <Seo
        title="Sign In / Sign Up | SoudFlex"
        description="Sign in or create an account to manage your watchlist, sync history, and get personalized recommendations."
      />
      <div className="min-h-screen w-full bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-[400px] z-10">
          ...
          {/* Login Card */}
          <div className="bg-card/30 backdrop-blur-xl border border-border/50 rounded-2xl p-6 md:p-8 shadow-2xl text-center">
            <h2 className="text-xl md:text-2xl font-bold text-white mb-2">
              Sign In / Sign Up
            </h2>
            <p className="text-sm text-muted-foreground mb-8">
              Continue with your Google account to track your watchlist and get personalized recommendations.
            </p>

            <button
              type="button"
              onClick={handleGoogleSignIn}
              className="flex items-center justify-center w-full gap-3 bg-white hover:bg-gray-100 text-gray-900 font-semibold px-4 py-3 rounded-xl transition-all border border-gray-200 shadow-sm hover:shadow-md"
            >
